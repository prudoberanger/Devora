    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-orange-500 focus:border-orange-500"
            />
          </div>
          <div>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link href="/inscription" className="text-orange-500 font-semibold hover:underline">Inscription</Link>
        </p>
      </div>
    </div>
  );
